...
import com.maxiflexy.orderservice.repository.OrderEventRepository;
...
public class OrderEventService {
    ...
    // convert from json payload to a string
    ...
    // convert from string to json payload type provided
