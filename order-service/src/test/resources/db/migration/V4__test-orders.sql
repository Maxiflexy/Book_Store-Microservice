...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'order-123', 'user', 'Siva', 'siva@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'NIGERIA', 'NEW', null),
                                         (2, 'order-456', 'user', 'Prasad', 'prasad@gmail.com', '2222222', '123 Main St', 'Apt 1', 'Hyderabad', 'TS', '500072', 'NIGERIA', 'NEW', null);
